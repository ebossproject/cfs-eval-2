...
# NOTE: PLEASE SEE utils/CommandList.py FOR COMMAND LIST FOR MM
# NOTE: PLEASE ALSO SEE utils/PacketSender.py FOR SYNTAX FOR send_commmand()
# TODO: Replace with actual command and arguments
# result = packet_sender.send_command("CFS_COMMAND", arg1, arg2)
...
if asan:
    ...
    if expected:
        ...
        print("Expected outcome not found, POV unsuccessful. If remediating, cFS did not crash")
